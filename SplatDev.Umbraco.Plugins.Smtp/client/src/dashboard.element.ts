...
@customElement("splatdev-smtp-dashboard")
export class SplatdevSMTPSettingsDashboardElement extends UmbElementMixin(LitElement) {
...
export default SplatdevSMTPSettingsDashboardElement;
