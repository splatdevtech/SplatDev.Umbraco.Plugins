...
@customElement("splatdev-whatsapp-dashboard")
export class SplatdevWhatsAppIntegrationDashboardElement extends UmbElementMixin(LitElement) {
...
export default SplatdevWhatsAppIntegrationDashboardElement;
