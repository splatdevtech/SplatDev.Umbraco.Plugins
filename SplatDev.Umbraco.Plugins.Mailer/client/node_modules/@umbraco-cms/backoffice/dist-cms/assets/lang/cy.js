export default {
    ...
    media: {
        ...
        uploadValidationFailed: (mediaTypeName) => `Mae gan y math cyfryngau ${mediaTypeName} un neu fwy o briodweddau gofynnol. Bydd angen ei huwchlwytho'n unigol drwy'r ddewislen 'Creu'`,
    ...
    logViewer: {
        ...
        polling: 'Diweddaru',
        pollingInterval: (seconds) => `Pob ${seconds} eiliad`,
        pollingActive: (seconds) => `Diweddaru pob ${seconds}e`,
    },
    clipboard: {
