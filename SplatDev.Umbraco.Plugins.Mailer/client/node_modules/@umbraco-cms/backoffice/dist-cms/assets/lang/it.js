export default {
    ...
    media: {
        ...
        uploadValidationFailed: (mediaTypeName) => `Il tipo di media ${mediaTypeName} ha una o più proprietà richieste. Dovrà essere caricato singolarmente tramite il menu 'Crea'`,
    },
    member: {
    ...
    logViewer: {
        ...
        polling: 'Polling',
        pollingInterval: (seconds) => `Ogni ${seconds} secondi`,
        pollingActive: (seconds) => `Polling ogni ${seconds}s`,
    },
    clipboard: {
