...
export interface ManifestElementAndApi<ElementType extends UmbControllerHostElement = UmbControllerHostElement, ApiType extends UmbApi = UmbApi> extends ManifestBase {
    /**
     * @TJS-ignore
     */
    readonly API_TYPE?: ApiType;
