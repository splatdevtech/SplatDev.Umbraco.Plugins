...
export class DictionarymanagerDictionaryManagerDashboardElement extends UmbElementMixin(LitElement) {
...
export default DictionarymanagerDictionaryManagerDashboardElement;
