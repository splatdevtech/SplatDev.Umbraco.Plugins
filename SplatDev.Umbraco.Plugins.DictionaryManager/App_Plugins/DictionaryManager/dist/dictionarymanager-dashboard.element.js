import { LitElement as d, html as c, css as u, state as p, customElement as g } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as f } from "@umbraco-cms/backoffice/element-api";
var m = Object.defineProperty, b = Object.getOwnPropertyDescriptor, l = (s, t, r, i) => {
  for (var e = i > 1 ? void 0 : i ? b(t, r) : t, o = s.length - 1, n; o >= 0; o--)
    (n = s[o]) && (e = (i ? n(t, r, e) : n(e)) || e);
  return i && e && m(t, r, e), e;
};
let a = class extends f(d) {
  constructor() {
  ...
  render() {
    return c`
      ...
      <p class="description">Bulk import and export Umbraco dictionary items. Manage translations across languages.</p>
      <div class="status-card">
        <div class="status-icon">⚙️</div>
        <div class="status-text">
          <h2>Dictionary Manager <span class="badge">Active</span></h2>
      ...
      <div class="config-section">
        ...
        <div class="form-field">
          <label>Status</label>
          <uui-toggle label="Enable Dictionary Manager" checked></uui-toggle>
        </div>
        <div class="actions">
          <uui-button
            look="primary"
...
a = l([
  g("dictionarymanager-dashboard")
], a);
const h = a;
export {
  a as DictionarymanagerDictionaryManagerDashboardElement,
  h as default
};
