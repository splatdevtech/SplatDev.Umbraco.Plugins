...
@customElement("splatdev-properties-dashboard")
export class SplatdevPropertiesReportDashboardElement extends UmbElementMixin(LitElement) {
...
export default SplatdevPropertiesReportDashboardElement;
