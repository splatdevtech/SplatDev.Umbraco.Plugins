import { LitElement as p, html as d, css as u, state as c, customElement as f } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as m } from "@umbraco-cms/backoffice/element-api";
var g = Object.defineProperty, b = Object.getOwnPropertyDescriptor, l = (n, r, i, o) => {
  for (var e = o > 1 ? void 0 : o ? b(r, i) : r, s = n.length - 1, a; s >= 0; s--)
    (a = n[s]) && (e = (o ? a(r, i, e) : a(e)) || e);
...
let t = class extends m(p) {
  ...
  render() {
    return d`
      ...
      <p class="description">Generate reports of content type properties across your Umbraco site. Export as CSV or PDF.</p>
      <div class="status-card">
        <div class="status-icon">⚙️</div>
        <div class="status-text">
          <h2>Properties Report <span class="badge">Active</span></h2>
      ...
      <div class="config-section">
        ...
        <div class="form-field">
          <label>Status</label>
          <uui-toggle label="Enable Properties Report" checked></uui-toggle>
        </div>
        <div class="actions">
          <uui-button
            look="primary"
...
t = l([
  f("splatdev-properties-dashboard")
], t);
const h = t;
export {
  t as SplatdevPropertiesReportDashboardElement,
  h as default
};
