export default {
    ...
    assignDomain: {
        ...
        inherit: '繼承',
        setLanguage: '語言',
        setLanguageHelp: '改變目前節點以下其餘節點的文化設定，<br />或從父節點繼承文化設定。<br />\n    也會改變目前節點設定，除非下方網域有其他項目。',
        setDomains: '功能變數名稱',
    },
    auditTrails: {
        atViewingFor: '查看',
    ...
    content: {
        ...
        scheduledPublishDocumentation: '<a href="https://docs.umbraco.com/umbraco-cms/fundamentals/data/scheduled-publishing#timezones" target="_blank" rel="noopener">這是什麼意思？</a>',
        saveModalTitle: '保存',
    },
    media: {
    ...
    defaultdialogs: {
        ...
        regexSearchError: "<a target='_blank' rel='noopener' href='http://regexlib.com'>regexlib.com</a>的網站服務目前出現些狀況，而我們無能為力。我們對此不便感到十分抱歉。",
    ...
    installer: {
        ...
        databaseText: '要完成此步驟，您必須瞭解連結資料庫伺服器的重要資訊("connection string")。<br />\n        若需要時，請聯繫您的網路公司。如果您在本地機器或伺服器安裝的話，您也許需要聯絡系統管理者。',
        ...
        defaultUserDisabled: '<strong>預設使用者已經被暫停或沒有Umbraco的使用權！</strong></p><p>不需更多的操作步驟。點選<strong>下一步</strong>繼續。',
        defaultUserPassChanged: '<strong>安裝後預設使用者的密碼已經成功修改！</strong></p><p>不需更多的操作步驟。點選<strong>下一步</strong>繼續。',
        ...
        permissionsAlmostPerfect: '<strong>您的權限設定幾近完美！</strong><br /><br />\n        您可以正常執行Umbraco沒有任何問題，只差您將沒有辦法安裝那些建議需要全部許可權的插件。',
        ...
        permissionsMaybeAnIssue: '<strong>您的權限可能有點小問題！</strong>\n      <br/><br />\n      您可以正常執行Umbraco沒有任何問題，然而您將無法新增資料夾或安裝那些可以讓Umbraco發揮全力的插件。',
        permissionsNotReady: '<strong>您的權限設定尚未未完成！</strong>\n          <br /><br />\n         您需要更新權限設定才能執行Umbraco。',
        permissionsPerfect: '<strong>您的權限設定完美無瑕！</strong><br /><br />\n              您已經準備好執行Umbraco和安裝插件！',
        ...
        theEndFurtherHelp: '<h3>更多的幫忙與資訊</h3>\n從我們獲獎的社群得到幫助，瀏覽文件，或觀看免費影片來瞭解如何輕鬆架設網站，如何使用插件，和瞭解Umbraco項目名稱的快速上手指引。',
        theEndHeader: '系統 %0% 安裝完畢',
        theEndInstallSuccess: '您可以點選下方按鈕「啟動Umbraco」來獲得<strong>快速開始指引</strong>。<br />如果您是<strong>Umbraco的新成員</strong>，\n您可以在其中找到相當多的資源。',
        theEndOpenUmbraco: '<h3>啟動Umbraco</h3>\n想要管理您的網站時，只需開啟Umbraco後台便可增加內容，更新範本和樣式表，或增添新功能。',
        Unavailable: '無法連接到資料庫。',
        Version3: '系統版本 3',
        Version4: '系統版本 4',
        watch: '觀看',
        welcomeIntro: '精靈會指引您完成設定Umbraco的過程，以便重新開始或升級到3.0。<br /><br />\n                               點選<strong>"下一步"</strong>來啟動精靈。',
    },
    language: {
        cultureCode: '語言代碼',
        displayName: '語言名稱',
    ...
    login: {
        ...
        resetPasswordEmailCopyFormat: '<p>您登入到後台的使用者名稱是：<strong>%0%</strong></p><p>點選<a href="%1%"><strong>這裡</strong></a>來重設您的密碼或將此連結複製/貼上到您的瀏覽器：</p><p><em>%1%</em></p>',
    },
    main: {
        dashboard: '儀錶板',
        sections: '區域',
    ...
    packager: {
        ...
        packageNoItemsText: '這個擴展包檔案裡面沒有任何移除項目資訊。<br/><br/>\n      您可以點選下方「移除擴展包」來安全地移除此項目。',
        packageOptions: '選項',
        packageReadme: '說明',
    ...
    publish: {
        ...
        publishHelp: '點選<em>發佈</em>按鈕來將<strong>%0%</strong>的內容設定為公開。<br/><br />\n      您可以同時發佈本頁以及其子項目若您點選下面的<em>包含子頁</em>。\n      ',
    },
    colorpicker: {
    ...
    healthcheck: {
        ...
        clickJackingCheckHeaderFound: '標頭或meta-tag的 <strong>X-Frame-Options</strong> 設定能控制網站是否可以被其他人IFRAMEd已找到。',
        clickJackingCheckHeaderNotFound: '標頭或meta-tag的 <strong>X-Frame-Options</strong> 設定能控制網站是否可以被其他人IFRAMEd沒有找到。',
