export default {
    ...
    media: {
        ...
        uploadValidationFailed: (mediaTypeName) => `O tipo de multimédia ${mediaTypeName} tem uma ou mais propriedades obrigatórias. Terá de ser carregado individualmente através do menu 'Criar'`,
    },
    member: {
    ...
    defaultdialogs: {
        ...
        cannotTrashWhenReferenced: (name) => `<strong>${name}</strong> não pode ser movido para a Reciclagem porque é referenciado por outros itens.`,
        confirmTrash: (name) => `Tem a certeza que quer mover <strong>${name}</strong> para a Reciclagem?`,
        cannotBulkTrashWhenReferenced: (total) => `Os <strong>${total} ${total === 1 ? 'item selecionado' : 'itens selecionados'}</strong> não podem ser movidos para a Reciclagem porque pelo menos um item é referenciado por outro conteúdo.`,
    ...
    logViewer: {
        ...
        polling: 'Polling',
        pollingInterval: (seconds) => `A cada ${seconds} segundos`,
        pollingActive: (seconds) => `Polling a cada ${seconds}s`,
    },
    clipboard: {
    ...
    missingEditor: {
        ...
        description: 'Não se preocupe, o seu conteúdo está seguro e a publicação deste documento não o substituirá nem removerá.<br/>Entre em contacto com o administrador do site para resolver o problema.',
        detailsTitle: 'Detalhes adicionais',
        detailsDescription: 'Para resolver o problema, deverá ou restaurar o editor de propriedades, ou alterar a propriedade para usar um tipo de dados compatível ou remover a propriedade se ela não for mais necessária.',
    ...
    dateTimePicker: {
        local: 'Local',
        differentTimeZoneLabel: (offset, localDate) => `A hora selecionada (${offset}) é equivalente a ${localDate} no fuso horário local.`,
