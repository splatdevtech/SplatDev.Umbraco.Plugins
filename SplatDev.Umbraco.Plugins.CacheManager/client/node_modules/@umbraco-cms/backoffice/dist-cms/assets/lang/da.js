export default {
    ...
    content: {
        ...
        openSplitViewForVariant: (variant) => `Åbn ${variant} i sidestillet visning`,
    },
    blueprints: {
    ...
    media: {
        ...
        uploadValidationFailed: (mediaTypeName) => `Medietypen ${mediaTypeName} har en eller flere påkrævede egenskaber. Det skal uploades individuelt via menuen 'Opret'`,
    },
    member: {
    ...
    defaultdialogs: {
        ...
        cannotTrashWhenReferenced: (name) => `<strong>${name}</strong> kan ikke flyttes til papirkurven, fordi det refereres af andre elementer.`,
        confirmTrash: (name) => `Er du sikker på, at du vil flytte <strong>${name}</strong> til papirkurven?`,
        cannotBulkTrashWhenReferenced: (total) => `De valgte <strong>${total} ${total === 1 ? 'element' : 'elementer'}</strong> kan ikke flyttes til papirkurven, fordi mindst \u00e9t element refereres af andet indhold.`,
    ...
    general: {
        ...
        dividerPosition: (value) => `Skillevæg ved ${value}%`,
        discard: 'Kassér',
        down: 'Ned',
        download: 'Hent',
        edit: 'Rediger',
        ...
        document: 'Dokument',
        documentCount: (count) => (count === 1 ? '1 dokument' : `${count} dokumenter`),
    },
    colors: {
        black: 'Sort',
        blue: 'Blå',
    ...
    colorPickerConfigurations: {
        ...
        showLabelDescription: 'Viser et farvet felt og en etiket for hver farve i farvevælgeren i stedet for blot et farvet felt.',
    },
    contentPicker: {
    ...
    logViewer: {
        ...
        searchThisMessageOnOurUmbracoForumsAndDocs: 'Søg efter denne besked på Our Umbraco forum og dokumentation',
        ...
        polling: 'Hent automatisk',
        pollingInterval: (seconds) => `Hver ${seconds} sekunder`,
        pollingActive: (seconds) => `Henter hver ${seconds}s`,
        noResults: 'Beklager, vi kan ikke finde det du leder efter.',
        sortLogs: 'Sorter logs',
        loadingLogs: 'Indlæser log beskeder...',
        searchLogs: 'Søg logs',
        searchLogsPlaceholder: 'Søg logs...',
        searchFor: 'Søg efter %0%',
        findLogsWith: 'Find logs med %0%',
        query: 'Forespørgsel',
        searchName: 'Søgenavn',
        startPolling: 'Start polling',
        choosePollingInterval: 'Vælg polling interval',
        selectLogLevels: 'Vælg log typer',
        all: 'Alle',
        from: 'Fra',
        to: 'Til',
        unableToViewLogs: 'Kan ikke vise logs',
        logFileTooLarge: 'Dagens logfil er for stor til at blive vist og vil forårsage ydelsesproblemer.',
        narrowDateRangeOrOpenManually: 'Hvis du har brug for at se logfilerne, indsnævr dit datoområde eller prøv at åbne dem manuelt.',
    ...
    blockEditor: {
        ...
        labelCustomViewDescription: 'Overskrift hvordan denne blok præsenteres i backoffice interfacet. Vælg en\n      .html fil der indeholder din præsensation.\n    ',
        ...
        createThisFor: (name, variantName) => variantName ? `Opret ${name} for ${variantName}` : `Opret ${name}`,
    ...
    preview: {
        ...
        connectionFailed: 'Kunne ikke etablere forbindelse til serveren, forhåndsvisning af liveopdateringer vil ikke fungere.',
