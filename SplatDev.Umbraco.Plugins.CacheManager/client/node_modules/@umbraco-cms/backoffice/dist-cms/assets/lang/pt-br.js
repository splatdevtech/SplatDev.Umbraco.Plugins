export default {
    ...
    errorHandling: {
        ...
        errorChangingProviderPassword: 'O provedor de membros (Membership provider) atual não suporta alterações de senha (EnablePasswordRetrieval tem que estar definida como true)',
    ...
    errors: {
        ...
        pictureResizeBiggerThanOrg: 'Você está prestes a tornar esta figura maior que o tamanho original. Tem certeza que deseja prosseguir?',
