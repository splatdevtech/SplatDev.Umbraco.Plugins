import { LitElement as l, html as u, css as p, state as c, customElement as f } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as v } from "@umbraco-cms/backoffice/element-api";
var g = Object.defineProperty, m = Object.getOwnPropertyDescriptor, d = (n, i, o, a) => {
  for (var e = a > 1 ? void 0 : a ? m(i, o) : i, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (e = (a ? s(i, o, e) : s(e)) || e);
  return a && e && g(i, o, e), e;
};
let t = class extends v(l) {
  ...
  render() {
    return u`
      <h1>Video Preview</h1>
      <p class="description">Video preview thumbnail generation and management. Configure preview formats and storage.</p>
      <div class="status-card">
        <div class="status-icon">⚙️</div>
        <div class="status-text">
          <h2>Video Preview <span class="badge">Active</span></h2>
      ...
      <div class="config-section">
        ...
        <div class="form-field">
          <label>Status</label>
          <uui-toggle label="Enable Video Preview" checked></uui-toggle>
        </div>
        <div class="actions">
          <uui-button
            look="primary"
...
t = d([
  f("splatdev-video-preview-dashboard")
], t);
const h = t;
export {
  t as SplatdevVideoPreviewDashboardElement,
  h as default
};
