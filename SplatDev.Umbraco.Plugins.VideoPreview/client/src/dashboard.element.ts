...
@customElement("splatdev-video-preview-dashboard")
export class SplatdevVideoPreviewDashboardElement extends UmbElementMixin(LitElement) {
...
export default SplatdevVideoPreviewDashboardElement;
