...
{
    public class FormBuilderExtensionApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Form Builder Extension Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<FormBuilderExtensionOperationSecurityFilter>();
            });
        }

        public class FormBuilderExtensionOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("FormBuilder.Extension.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
