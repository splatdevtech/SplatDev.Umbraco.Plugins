...
var m = Object.defineProperty, b = Object.getOwnPropertyDescriptor, l = (n, i, a, o) => {
  for (var e = o > 1 ? void 0 : o ? b(i, a) : i, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (e = (o ? r(i, a, e) : r(e)) || e);
...
let t = class extends g(d) {
  ...
  render() {
    return u`
      <h1>GDPR & Cookies</h1>
      <p class="description">GDPR compliance tools. Manage cookie consent banners, privacy policies, and data subject requests.</p>
      <div class="status-card">
        <div class="status-icon">⚙️</div>
        <div class="status-text">
          <h2>GDPR & Cookies <span class="badge">Active</span></h2>
      ...
      <div class="config-section">
        ...
        <div class="form-field">
          <label>Status</label>
          <uui-toggle label="Enable GDPR & Cookies" checked></uui-toggle>
        </div>
        <div class="actions">
          <uui-button
            look="primary"
...
t = l([
  f("splatdev-gdpr-dashboard")
], t);
const h = t;
export {
  t as SplatdevGdprCookiesDashboardElement,
  h as default
};
