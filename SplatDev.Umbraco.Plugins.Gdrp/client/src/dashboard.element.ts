...
@customElement("splatdev-gdpr-dashboard")
export class SplatdevGdprCookiesDashboardElement extends UmbElementMixin(LitElement) {
...
export default SplatdevGdprCookiesDashboardElement;
