...
@customElement("splatdev-settings-dashboard")
export class SplatdevSiteSettingsDashboardElement extends UmbElementMixin(LitElement) {
...
export default SplatdevSiteSettingsDashboardElement;
