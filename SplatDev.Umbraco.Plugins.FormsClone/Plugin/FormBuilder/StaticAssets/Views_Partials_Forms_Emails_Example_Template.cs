...
namespace FormBuilder.StaticAssets
{
      ...
      UmbracoViewPage<FormsHtmlModel>
    {
        ...
        public override async Task ExecuteAsync()
        {
            ...
            string? assetUrl = emailsExampleTemplate.Context.Request.Scheme + "://" + emailsExampleTemplate.Context.Request.Host.ToString() + "/App_Plugins/FormBuilder/assets/Email-Example";
