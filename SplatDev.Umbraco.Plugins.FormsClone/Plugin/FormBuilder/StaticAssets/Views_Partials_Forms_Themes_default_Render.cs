...
using FormBuilder.Web.Controllers;
        ...
        RazorPage<FormViewModel>
    {
        public override async Task ExecuteAsync()
        {
            ...
            else
            {
                ...
                themesDefaultRender.EndWriteAttribute();
                themesDefaultRender.WriteLiteral(">\n");
                using (themesDefaultRender.Html?.BeginUmbracoForm<FormBuilderController>("HandleForm", null, themesDefaultRender.Model.HtmlAttributes, FormMethod.Post, new bool?(themesDefaultRender.Model.RenderAntiForgeryToken)))
                {
