(function () {
    ...
    function listen() {
        ...
        // Inline script setting FormBuildersCollection was removed in 8.11/9.3, and replaced by config elements.
        ...
        if (configElements.length > 0) {
            var FormBuildersCollectionFromConfig = [];
            for (var i = 0; i < configElements.length; i++) {
                ...
                FormBuildersCollectionFromConfig.push(form);
            }
            initCollection(FormBuildersCollectionFromConfig, true);  // Set the 'jsonParsed' flag, indicating that we already have a JSON structure, which we don't have with the legacy, inline script method.
        } else {
            if (typeof FormBuildersCollection === "undefined") {
                //this will occur if this js file is loaded before the inline scripts, in which case
                //we'll listen for the inline scripts to execute a custom event.
                document.addEventListener("FormBuilderLoaded", init);
            }
            else {
                initCollection(FormBuildersCollection);
            }
        }
    ...
    function initCollection(formsCollection, jsonParsed) {
        configureFormBuildersValidation(formsCollection);
    ...
    function init(e, jsonParsed) {
        ...
        for (var i = 0; i < forms.length; i++) {
            ...
            var conditions = new FormBuildersConditions(page,
    ...
    function scrollToSubmittedForm(formClientId) {
        document.onreadystatechange = function () {
            ...
            if (document.readyState == "complete") {
                ...
                // - When the form has been submitted, we should scroll to the displayed message (which will have class 'formbuilder-forms-submitmessage' or 'formbuilder-forms-submitmessage-html').
                ...
                var messageOnSubmitElement = document.querySelectorAll(".formbuilder-forms-submitmessage");
                var messageOnSubmitHtmlElement = document.querySelectorAll(".formbuilder-forms-submitmessage-html");
    ...
    function configureFormBuildersValidation(formsCollection) {
        ...
        if (window.aspnetValidation !== undefined) {
            ...
            var FormBuilders_regex = function (value, element, params) {
            ...
            validationService.addProvider("FormBuilders_regex", FormBuilders_regex);
            ...
            window.FormBuildersValidationService = validationService;
            ...
            $.validator.addMethod("FormBuilders_regex", function (value, element) {
            ...
            $.validator.unobtrusive.adapters.addBool("regex", "FormBuilders_regex");
    ...
    function setFocusToFirstElementOnValidationError(formEl) {
        ...
        if (window.aspnetValidation !== undefined) {
            ...
            // For jquery.validate, we need to hook this in as part of the submit handler coded in configureFormBuildersValidation();
        }
     ...
     */
    function FormBuildersConditions(form, pageButtonConditions, fieldsetConditions, fieldConditions, triggerConditionsCheckOn, values, formElementHtmlIdPrefix) {
