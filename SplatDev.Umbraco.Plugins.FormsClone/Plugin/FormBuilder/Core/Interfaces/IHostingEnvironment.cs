namespace FormBuilder.Core.Interfaces
{
    public interface IHostingEnvironment
    {
        ...
        ///         Usage of this must take into account that the same         ///         Umbraco website hosted on different servers.<br />
        ...
        ///         value of         ///         implementation of IApplicationDiscriminator has been registered).<br />
        ///         However during ConfigureServices a temporary instance of IHostingEnvironment is constructed which guarantees
        ///         that this will be the hash of         ///         the value may differ depend on when the property is used.
        ///     </para>
        ///     <para>
        ...
        ///     map to "/site/pages/test" where "/site" is the value of         /// </remarks>
