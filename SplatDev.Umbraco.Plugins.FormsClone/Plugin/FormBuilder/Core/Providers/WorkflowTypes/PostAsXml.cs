...
using FormBuilder.Core.Providers.Extensions;
...
namespace FormBuilder.Core.Providers.WorkflowTypes
{
    ...
    public class PostAsXml : WorkflowType
    {
        ...
        {
            Id = new Guid("470EEB3A-CB15-4B08-9FC0-A2F091583332");
            Name = "Post as XML";
            Alias = "postAsXml";
            Description = "Posts the form as XML to a URL";
            Icon = "icon-code";
            Group = "Legacy";
        ...
        /// <summary>
        /// Gets or sets the path to an XSLT file used to transform the XML before posting it.
        /// </summary>
        ...
        /// <summary>Gets or sets the default element name for fieldss.</summary>
          ...
          WorkflowExecutionContext context)
        {
            ...
            if (!string.IsNullOrEmpty(postAsXml.Fields))
            {
                ...
                if (source is not null)
                    fieldMappingList = [.. source];
            }
            NameValueCollection? nameValueCollection = [];
            if (fieldMappingList.Count != 0)
            {
            ...
            HttpRequestMessage request = new(new HttpMethod(postAsXml.Method), new Uri(postAsXml.Url));
            ...
            foreach (var name in nameValueCollection.AllKeys.Where(x => x is not null))
