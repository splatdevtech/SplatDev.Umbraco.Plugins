...
namespace FormBuilder.Core.Cache
{
    ...
    public sealed class DistributedCache(IServerMessenger serverMessenger, CacheRefresherCollection cacheRefreshers)
    {
        private readonly IServerMessenger _serverMessenger = serverMessenger;
        private readonly CacheRefresherCollection _cacheRefreshers = cacheRefreshers;

        /// <summary>
        /// Notifies the distributed cache of specified item invalidation, for a specified         /// </summary>
        ...
        /// <summary>
        /// Notifies the distributed cache of a specified item invalidation, for a specified         /// </summary>
        /// <param name="refresherGuid">The unique identifier of the cache refresher.</param>
        ...
        /// <summary>
        /// Notifies the distributed cache of a global invalidation for a specified         /// </summary>
        /// <param name="refresherGuid">The unique identifier of the cache refresher.</param>
        ...
        /// <summary>
        /// Notifies the distributed cache of a specified item removal, for a specified         /// </summary>
        /// <param name="refresherGuid">The unique identifier of the cache refresher.</param>
        ...
        /// <summary>
        /// Notifies the distributed cache of specified item removal, for a specified         /// </summary>
