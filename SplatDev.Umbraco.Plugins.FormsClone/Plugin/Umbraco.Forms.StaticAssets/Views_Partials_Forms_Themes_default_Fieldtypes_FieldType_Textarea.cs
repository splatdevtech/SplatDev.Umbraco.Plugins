...
namespace UmbracoForms.StaticAssets
{
      ...
      RazorPage<FieldViewModel>
    {
        public override async Task ExecuteAsync()
        {
            ...
            string? settingValue1 = fieldTypeTextarea.Model.GetSettingValue("AutocompleteAttribute", string.Empty);
            int settingValue2 = fieldTypeTextarea.Model.GetSettingValue("NumberOfRows", 2);
            ...
            fieldTypeTextarea.WriteAttributeValue("", 410, fieldTypeTextarea.Html?.GetFormFieldClass(fieldTypeTextarea.Model.FieldTypeName), 410, 44, false);
            fieldTypeTextarea.EndWriteAttribute();
            fieldTypeTextarea.BeginWriteAttribute("name", "\n          name=\"", 455, "\"", 483, 1);
            fieldTypeTextarea.WriteAttributeValue("", 472, fieldTypeTextarea.Model.Name, 472, 11, false);
            fieldTypeTextarea.EndWriteAttribute();
            fieldTypeTextarea.BeginWriteAttribute("id", "\n          id=\"", 484, "\"", 508, 1);
            fieldTypeTextarea.WriteAttributeValue("", 499, fieldTypeTextarea.Model.Id, 499, 9, false);
            fieldTypeTextarea.EndWriteAttribute();
            fieldTypeTextarea.WriteLiteral("\n          data-umb=\"");
            fieldTypeTextarea.Write(fieldTypeTextarea.Model.Id);
            fieldTypeTextarea.WriteLiteral("\"");
            fieldTypeTextarea.BeginWriteAttribute("rows", "\n          rows=\"", 540, "\"", 570, 1);
            fieldTypeTextarea.WriteAttributeValue("", 557, settingValue2, 557, 13, false);
            fieldTypeTextarea.EndWriteAttribute();
            fieldTypeTextarea.WriteLiteral("\n          cols=\"20\"\n          ");
            ...
            if (settingValue3 > 0)
            {
                ...
                fieldTypeTextarea.Write(settingValue3);
                fieldTypeTextarea.WriteLiteral("\" ");
            }
            fieldTypeTextarea.WriteLiteral("\n          ");
            ...
            if (fieldTypeTextarea.Model.Validate)
            {
                ...
                fieldTypeTextarea.Write(fieldTypeTextarea.Html?.Raw(fieldTypeTextarea.Model.Regex));
                fieldTypeTextarea.WriteLiteral("\" ");
            }
            fieldTypeTextarea.WriteLiteral("\n          ");
            ...
            fieldTypeTextarea.WriteLiteral(">");
            fieldTypeTextarea.Write(fieldTypeTextarea.Model.ValueAsHtmlString);
            fieldTypeTextarea.WriteLiteral("</textarea>\n\n");
