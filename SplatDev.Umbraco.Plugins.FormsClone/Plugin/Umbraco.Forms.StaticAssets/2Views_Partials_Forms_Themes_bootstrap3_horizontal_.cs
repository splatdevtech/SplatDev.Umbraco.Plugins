...
// Type: AspNetCoreGeneratedDocument.Views_Partials_Forms_Themes_bootstrap3_horizontal_Form
...
#nullable disable
        Task ExecuteAsync()
        {
            ...
            bootstrap3HorizontalForm1.WriteAttributeValue("", 716, bootstrap3HorizontalForm1.Model.CurrentPage != null ? bootstrap3HorizontalForm1.Model.CurrentPage.Id : "umbraco-forms-summary-page", 716, 82, false);
            ...
            else
            {
                ...
                foreach (FieldsetViewModel fieldset in (IEnumerable<FieldsetViewModel>)bootstrap3HorizontalForm1.Model.CurrentPage.Fieldsets)
                {
                    ...
                    foreach (FieldsetContainerViewModel container in (IEnumerable<FieldsetContainerViewModel>)fieldset.Containers)
                    {
                        ...
                        foreach (FieldViewModel field in (IEnumerable<FieldViewModel>)container.Fields)
                        {
                            ...
                            {
                                bootstrap3HorizontalForm1.PushWriter(__razor_attribute_value_writer);
                                if (bootstrap3HorizontalForm1 is not null)
                                    bootstrap3HorizontalForm1.WriteLiteral(" umbraco-forms-hidden");
                                bootstrap3HorizontalForm1.PopWriter();
                            }), 2452, 71, false);
                            bootstrap3HorizontalForm1.EndWriteAttribute();
                            bootstrap3HorizontalForm1.WriteLiteral(">\n\n                                    <label");
