...
// Type: AspNetCoreGeneratedDocument.Views_Partials_Forms_Themes_default_Fieldtypes_FieldType_CheckBox
...
namespace AspNetCoreGeneratedDocument
{
    ...
    RazorPage<FieldViewModel>
  {
    ...
    Task ExecuteAsync()
    {
      ...
      fieldTypeCheckBox.Model.AdditionalSettings.TryGetValue("Caption", out empty);
      fieldTypeCheckBox.WriteLiteral("\n<input type=\"checkbox\"");
      fieldTypeCheckBox.BeginWriteAttribute("name", " name=\"", 173, "\"", 191, 1);
      fieldTypeCheckBox.WriteAttributeValue("", 180, (object) fieldTypeCheckBox.Model.Name, 180, 11, false);
      fieldTypeCheckBox.EndWriteAttribute();
      fieldTypeCheckBox.BeginWriteAttribute("id", " id=\"", 192, "\"", 206, 1);
      fieldTypeCheckBox.WriteAttributeValue("", 197, (object) fieldTypeCheckBox.Model.Id, 197, 9, false);
      fieldTypeCheckBox.EndWriteAttribute();
      ...
      fieldTypeCheckBox.WriteLiteral("       ");
      if (fieldTypeCheckBox.Model.ContainsValue((object) true) || fieldTypeCheckBox.Model.ContainsValue((object) "true") || fieldTypeCheckBox.Model.ContainsValue((object) "on"))
      ...
      fieldTypeCheckBox.WriteAttributeValue("", 814, (object) fieldTypeCheckBox.Model.Name, 814, 11, false);
      fieldTypeCheckBox.EndWriteAttribute();
      ...
      fieldTypeCheckBox.WriteAttributeValue("", 899, (object) fieldTypeCheckBox.Model.Id, 899, 9, false);
      fieldTypeCheckBox.EndWriteAttribute();
      fieldTypeCheckBox.WriteLiteral(">");
      fieldTypeCheckBox.Write(empty);
      fieldTypeCheckBox.WriteLiteral("</label>\n");
    }
