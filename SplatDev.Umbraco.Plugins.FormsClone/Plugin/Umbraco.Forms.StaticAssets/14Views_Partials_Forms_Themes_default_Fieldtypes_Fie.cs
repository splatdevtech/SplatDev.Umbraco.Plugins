...
// Type: AspNetCoreGeneratedDocument.Views_Partials_Forms_Themes_default_Fieldtypes_FieldType_Recaptcha3
    ...
    RazorPage<FieldViewModel>
  {
    ...
    Task ExecuteAsync()
    {
      ...
      if (!string.IsNullOrEmpty(siteKey))
      {
        ...
        fieldTypeRecaptcha3.WriteAttributeValue("", 730, (object) fieldTypeRecaptcha3.Model.Id, 730, 9, false);
    ...
    public 
    #nullable enable
    IOptionsSnapshot<Recaptcha3Settings> Configuration { get; private set; }
