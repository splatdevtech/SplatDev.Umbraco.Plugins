    ...
    internal sealed class Views_Partials_Forms_Themes_default_DatePicker : RazorPage<object>
    {
        public override async Task ExecuteAsync()
        {
            ...
            if (string.IsNullOrWhiteSpace(str))
                str = "LL";
            defaultDatePicker.Html?.AddFormThemeCssFile("~/App_Plugins/UmbracoForms/assets/pikaday/pikaday.min.css");
            defaultDatePicker.Html?.AddFormThemeScriptFile("~/App_Plugins/UmbracoForms/assets/moment/min/moment-with-locales.min.js");
            defaultDatePicker.Html?.AddFormThemeScriptFile("~/App_Plugins/UmbracoForms/assets/pikaday/pikaday.min.js");
            defaultDatePicker.Html?.AddFormThemeScriptFile("~/App_Plugins/UmbracoForms/assets/datepicker.init.min.js");
