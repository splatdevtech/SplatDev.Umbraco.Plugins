...
// Type: Umbraco.Forms.Web.Api.ManagementApi.Security.CreateUserFormSecurityController
...
{
  public class CreateUserFormSecurityController : CreateOrUpdateUserFormSecurityControllerBase
  {
    public CreateUserFormSecurityController(
    ...
    public async Task<IActionResult> Create(Guid id, FormSecurityForUser security)
    {
      ...
      return (IActionResult) securityController.Created();
    }
  }
}
