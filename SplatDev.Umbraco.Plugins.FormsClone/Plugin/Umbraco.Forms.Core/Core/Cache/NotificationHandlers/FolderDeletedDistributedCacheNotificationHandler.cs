...
// Type: Umbraco.Forms.Core.Cache.NotificationHandlers.FolderDeletedDistributedCacheNotificationHandler
...
namespace Umbraco.Forms.Core.Cache.NotificationHandlers
{
    ...
    DeletedDistributedCacheNotificationHandlerBase<Folder, FolderDeletedNotification>
  {
    ...
    public FolderDeletedDistributedCacheNotificationHandler(
      IFormsDistributedCache formsDbDistributedCache)
    {
      this._formsDbDistributedCache = formsDbDistributedCache;
    }

    protected override void Handle(IEnumerable<Folder> entities) => this._formsDbDistributedCache.RemoveFolders(entities);
  }
}
