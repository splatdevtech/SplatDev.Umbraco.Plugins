...
// Type: Umbraco.Forms.Core.Cache.NotificationHandlers.FormSavedDistributedCacheNotificationHandler
...
namespace Umbraco.Forms.Core.Cache.NotificationHandlers
{
    ...
    SavedDistributedCacheNotificationHandlerBase<Form, FormSavedNotification>
  {
    ...
    public FormSavedDistributedCacheNotificationHandler(
      IFormsDistributedCache formsDbDistributedCache)
    {
      this._formsDbDistributedCache = formsDbDistributedCache;
    }

    protected override void Handle(IEnumerable<Form> entities) => this._formsDbDistributedCache.RefreshForms(entities);
  }
}
