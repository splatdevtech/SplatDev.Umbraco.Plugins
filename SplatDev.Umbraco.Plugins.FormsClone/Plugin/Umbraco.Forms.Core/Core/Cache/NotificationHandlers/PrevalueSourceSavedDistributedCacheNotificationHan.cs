...
// Type: Umbraco.Forms.Core.Cache.NotificationHandlers.PrevalueSourceSavedDistributedCacheNotificationHandler
...
namespace Umbraco.Forms.Core.Cache.NotificationHandlers
{
    ...
    SavedDistributedCacheNotificationHandlerBase<FieldPreValueSource, PrevalueSourceSavedNotification>
  {
    ...
    public PrevalueSourceSavedDistributedCacheNotificationHandler(
      IFormsDistributedCache formsDbDistributedCache)
    {
      this._formsDbDistributedCache = formsDbDistributedCache;
    }

    protected override void Handle(IEnumerable<FieldPreValueSource> entities) => this._formsDbDistributedCache.RefreshPrevalueSources(entities);
  }
}
