...
// Type: Umbraco.Forms.Core.Cache.NotificationHandlers.WorkflowDeletedDistributedCacheNotificationHandler
...
namespace Umbraco.Forms.Core.Cache.NotificationHandlers
{
    ...
    DeletedDistributedCacheNotificationHandlerBase<Workflow, WorkflowDeletedNotification>
  {
    ...
    public WorkflowDeletedDistributedCacheNotificationHandler(
      IFormsDistributedCache formsDbDistributedCache)
    {
      this._formsDbDistributedCache = formsDbDistributedCache;
    }

    protected override void Handle(IEnumerable<Workflow> entities) => this._formsDbDistributedCache.RemoveWorkflows(entities);
  }
}
