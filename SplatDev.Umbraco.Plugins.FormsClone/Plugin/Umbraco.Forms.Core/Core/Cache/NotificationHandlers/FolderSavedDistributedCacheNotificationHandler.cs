...
// Type: Umbraco.Forms.Core.Cache.NotificationHandlers.FolderSavedDistributedCacheNotificationHandler
...
namespace Umbraco.Forms.Core.Cache.NotificationHandlers
{
    ...
    SavedDistributedCacheNotificationHandlerBase<Folder, FolderSavedNotification>
  {
    ...
    public FolderSavedDistributedCacheNotificationHandler(
      IFormsDistributedCache formsDbDistributedCache)
    {
      this._formsDbDistributedCache = formsDbDistributedCache;
    }

    protected override void Handle(IEnumerable<Folder> entities) => this._formsDbDistributedCache.RefreshFolders(entities);
  }
}
