...
// Type: Umbraco.Forms.Core.Cache.NotificationHandlers.FormDeletedDistributedCacheNotificationHandler
...
namespace Umbraco.Forms.Core.Cache.NotificationHandlers
{
    ...
    DeletedDistributedCacheNotificationHandlerBase<Form, FormDeletedNotification>
  {
    ...
    public FormDeletedDistributedCacheNotificationHandler(
      IFormsDistributedCache formsDbDistributedCache)
    {
      this._formsDbDistributedCache = formsDbDistributedCache;
    }

    protected override void Handle(IEnumerable<Form> entities) => this._formsDbDistributedCache.RemoveForms(entities);
  }
}
