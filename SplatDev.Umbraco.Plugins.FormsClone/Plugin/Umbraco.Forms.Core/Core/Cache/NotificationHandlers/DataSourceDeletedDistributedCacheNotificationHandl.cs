...
// Type: Umbraco.Forms.Core.Cache.NotificationHandlers.DataSourceDeletedDistributedCacheNotificationHandler
...
namespace Umbraco.Forms.Core.Cache.NotificationHandlers
{
    ...
    DeletedDistributedCacheNotificationHandlerBase<FormDataSource, DataSourceDeletedNotification>
  {
    ...
    public DataSourceDeletedDistributedCacheNotificationHandler(
      IFormsDistributedCache formsDbDistributedCache)
    {
      this._formsDbDistributedCache = formsDbDistributedCache;
    }

    protected override void Handle(IEnumerable<FormDataSource> entities) => this._formsDbDistributedCache.RemoveDataSources(entities);
  }
}
