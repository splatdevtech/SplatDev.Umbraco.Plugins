...
var m = Object.defineProperty, b = Object.getOwnPropertyDescriptor, l = (n, i, o, a) => {
  for (var t = a > 1 ? void 0 : a ? b(i, o) : i, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (t = (a ? r(i, o, t) : r(t)) || t);
  return a && t && m(i, o, t), t;
};
let e = class extends g(d) {
  ...
  render() {
    return c`
      ...
      <p class="description">Configure site-wide toast notification styles, timing, and placement for user feedback messages.</p>
      <div class="status-card">
        <div class="status-icon">⚙️</div>
        <div class="status-text">
          <h2>Toast Notifications <span class="badge">Active</span></h2>
      ...
      <div class="config-section">
        ...
        <div class="form-field">
          <label>Status</label>
          <uui-toggle label="Enable Toast Notifications" checked></uui-toggle>
        </div>
        <div class="actions">
          <uui-button
            look="primary"
...
e = l([
  f("splatdev-toast-dashboard")
], e);
const h = e;
export {
  e as SplatdevToastNotificationsDashboardElement,
  h as default
};
