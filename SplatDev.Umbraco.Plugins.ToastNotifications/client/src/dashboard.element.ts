...
@customElement("splatdev-toast-dashboard")
export class SplatdevToastNotificationsDashboardElement extends UmbElementMixin(LitElement) {
...
export default SplatdevToastNotificationsDashboardElement;
