...
var m = Object.defineProperty, b = Object.getOwnPropertyDescriptor, l = (n, t, o, a) => {
  for (var e = a > 1 ? void 0 : a ? b(t, o) : t, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (e = (a ? r(t, o, e) : r(e)) || e);
  return a && e && m(t, o, e), e;
};
let i = class extends g(d) {
  constructor() {
  ...
  render() {
    return c`
      ...
      <p class="description">Enable single sign-on via social platforms. Configure OAuth2 for Google, Facebook, and Twitter login.</p>
      <div class="status-card">
        <div class="status-icon">⚙️</div>
        <div class="status-text">
          <h2>Social Media Login <span class="badge">Active</span></h2>
      ...
      <div class="config-section">
        ...
        <div class="form-field">
          <label>Status</label>
          <uui-toggle label="Enable Social Media Login" checked></uui-toggle>
        </div>
        <div class="actions">
          <uui-button
            look="primary"
...
l([
  p()
], i.prototype, "_saved", 2);
i = l([
  f("splatdev-social-login-dashboard")
], i);
const h = i;
export {
  i as SplatdevSocialMediaLoginDashboardElement,
  h as default
};
