...
@customElement("splatdev-social-login-dashboard")
export class SplatdevSocialMediaLoginDashboardElement extends UmbElementMixin(LitElement) {
...
export default SplatdevSocialMediaLoginDashboardElement;
