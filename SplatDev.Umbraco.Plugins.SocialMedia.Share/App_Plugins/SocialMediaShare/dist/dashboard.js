...
let t = class extends g(d) {
  ...
  render() {
    return c`
      ...
      <p class="description">Add social sharing buttons to content. Configure sharing for Twitter, Facebook, LinkedIn and more.</p>
      <div class="status-card">
        <div class="status-icon">⚙️</div>
        <div class="status-text">
          <h2>Social Media Share <span class="badge">Active</span></h2>
      ...
      <div class="config-section">
        ...
        <div class="form-field">
          <label>Status</label>
          <uui-toggle label="Enable Social Media Share" checked></uui-toggle>
        </div>
        <div class="actions">
          <uui-button
            look="primary"
...
t = l([
  f("splatdev-social-share-dashboard")
], t);
const v = t;
export {
  t as SplatdevSocialMediaShareDashboardElement,
  v as default
};
