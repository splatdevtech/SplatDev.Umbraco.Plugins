...
@customElement("splatdev-social-share-dashboard")
export class SplatdevSocialMediaShareDashboardElement extends UmbElementMixin(LitElement) {
...
export default SplatdevSocialMediaShareDashboardElement;
