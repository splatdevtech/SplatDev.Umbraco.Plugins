...
export type JsLoaderProperty<JsExportType> = string | JsLoaderPromise<JsExportType> | (JsExportType extends object ? JsExportType : never);
export type ElementLoaderProperty<ElementType extends HTMLElement = HTMLElement> = string | ElementLoaderPromise<ElementType> | ElementLoaderExports<ElementType> | ClassConstructor<ElementType>;
export type ApiLoaderProperty<ApiType extends UmbApi = UmbApi> = string | ApiLoaderPromise<ApiType> | ApiLoaderExports<ApiType> | ClassConstructor<ApiType>;
export type ElementAndApiLoaderProperty<ElementType extends HTMLElement = HTMLElement, ApiType extends UmbApi = UmbApi> = string | ElementAndApiLoaderPromise<ElementType, ApiType> | ElementAndApiLoaderExports<ElementType, ApiType> | ElementLoaderPromise<ElementType> | ElementLoaderExports<ElementType> | ApiLoaderPromise<ApiType> | ApiLoaderExports<ApiType>;
