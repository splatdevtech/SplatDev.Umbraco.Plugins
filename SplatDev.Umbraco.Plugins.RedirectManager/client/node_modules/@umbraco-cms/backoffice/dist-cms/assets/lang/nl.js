export default {
    ...
    media: {
        ...
        uploadValidationFailed: (mediaTypeName) => `Het mediatype ${mediaTypeName} heeft een of meer vereiste eigenschappen. Het moet afzonderlijk worden geüpload via het menu 'Maken'`,
    ...
    general: {
        ...
        dividerPosition: (value) => `Verdeler op ${value}%`,
        discard: 'Gooi weg',
        down: 'Omlaag',
        download: 'Download',
        edit: 'Bewerken',
    ...
    logViewer: {
        ...
        polling: 'Peilen',
        pollingInterval: (seconds) => `Elke ${seconds} seconden`,
        pollingActive: (seconds) => `Elke ${seconds}s peilen`,
    },
    clipboard: {
