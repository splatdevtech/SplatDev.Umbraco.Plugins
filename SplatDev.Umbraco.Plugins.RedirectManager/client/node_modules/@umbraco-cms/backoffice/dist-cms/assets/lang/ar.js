export default {
    ...
    media: {
        ...
        uploadValidationFailed: (mediaTypeName) => `نوع الوسائط ${mediaTypeName} يحتوي على خاصية مطلوبة أو أكثر. ستحتاج إلى تحميله بشكل فردي عبر قائمة 'إنشاء'`,
    },
    member: {
    ...
    logViewer: {
        ...
        polling: 'استطلاع',
        pollingInterval: (seconds) => `كل ${seconds} ثانية`,
        pollingActive: (seconds) => `استطلاع كل ${seconds} ثانية`,
    },
    clipboard: {
