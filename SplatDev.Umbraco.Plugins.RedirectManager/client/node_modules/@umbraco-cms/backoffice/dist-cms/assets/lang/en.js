export default {
    actions: {
        ...
        copyTo: 'Duplicate to',
        create: 'Create',
        createFor: (name) => (name ? `Create item for ${name}` : 'Create'),
    ...
    assignDomain: {
        ...
        domainHelpWithVariants: 'Valid hostnames are: "example.com", "www.example.com", "example.com:8080", or "https://www.example.com/". Furthermore also one-level paths in hostnames are supported, e.g. "example.com/en" or "/en".',
        inherit: 'Inherit',
        setLanguage: 'Culture',
        setLanguageHelp: 'Set the culture for nodes below the current node, or inherit culture from parent nodes. Will also apply to the current node, unless a hostname below applies too.',
    ...
    content: {
        ...
        openSplitViewForVariant: (variant) => `Open ${variant} in split view`,
    ...
    media: {
        ...
        disallowedFileExtension: (extension) => `Cannot upload .${extension} files as no media type supports this file type`,
        disallowedMediaTypeNotAllowedHere: (extension, mediaTypeName) => `Cannot upload .${extension} files here as the associated ${mediaTypeName} media type is not allowed at this location`,
        disallowedMediaTypesNotAllowedHere: (extension, mediaTypeNames) => `Cannot upload .${extension} files here as the associated media types (${mediaTypeNames}) are not allowed at this location`,
        ...
        uploadValidationFailed: (mediaTypeName) => `The ${mediaTypeName} media type has one or more required properties. It will need to be uploaded individually via the 'Create' menu`,
    },
    member: {
    ...
    defaultdialogs: {
        ...
        cannotTrashWhenReferenced: (name) => `<strong>${name}</strong> cannot be moved to the Recycle Bin because it is referenced by other items.`,
        confirmTrash: (name) => `Are you sure you want to move <strong>${name}</strong> to the Recycle Bin?`,
        cannotBulkTrashWhenReferenced: (total) => `The selected <strong>${total} ${total === 1 ? 'item' : 'items'}</strong> cannot be moved to the Recycle Bin because at least one item is referenced by other content.`,
    ...
    general: {
        ...
        dividerPosition: (value) => `Divider at ${value}%`,
        discard: 'Discard',
        document: 'Document',
        documentCount: (count) => (count === 1 ? '1 document' : `${count} documents`),
        down: 'Down',
        download: 'Download',
        edit: 'Edit',
        edited: 'Edited',
    ...
    colorPickerConfigurations: {
        ...
        showLabelDescription: 'Displays coloured field and a label for each colour in the colour picker, rather than just a coloured field.',
    },
    contentPicker: {
    ...
    speechBubbles: {
        ...
        publishWithNoDomains: 'Hostnames are not configured for multilingual site, please contact an administrator, see log for more information',
        publishWithMissingDomain: 'There is no hostname configured for %0%, please contact an administrator, see log for more information',
    ...
    logViewer: {
        ...
        polling: 'Polling',
        pollingInterval: (seconds) => `Every ${seconds} seconds`,
        pollingActive: (seconds) => `Polling every ${seconds}s`,
        ...
        narrowDateRangeOrOpenManually: 'If you need to view the log files, narrow your date range or try opening them manually.',
    ...
    missingEditor: {
        ...
        description: "Don't worry, your content is safe and publishing this document won't overwrite it or remove it.<br/>Please contact your site administrator to resolve this issue.",
        detailsTitle: 'Additional details',
        detailsDescription: "To resolve this you should either restore the property editor, change the property to use a supported data type or remove the property if it's no longer needed.",
        ...
        missingUiDetailsDescription: 'This property editor UI is missing. Ensure your custom UI is registered correctly and the alias matches your configuration.<br/>For implementation details, refer to the <a href="https://docs.umbraco.com/umbraco-cms/customizing/property-editors/composition/property-editor-ui" target="_blank" rel="noopener">documentation</a>.',
    ...
    dateTimePicker: {
        local: 'Local',
        differentTimeZoneLabel: (offset, localDate) => `The selected time (${offset}) is equivalent to ${localDate} in your local time.`,
