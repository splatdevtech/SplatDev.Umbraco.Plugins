...
@customElement("splatdev-live-video-dashboard")
export class SplatdevLiveVideoDashboardElement extends UmbElementMixin(LitElement) {
...
export default SplatdevLiveVideoDashboardElement;
