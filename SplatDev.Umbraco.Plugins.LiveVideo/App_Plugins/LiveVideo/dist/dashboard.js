...
var v = Object.defineProperty, g = Object.getOwnPropertyDescriptor, d = (n, i, o, a) => {
  for (var e = a > 1 ? void 0 : a ? g(i, o) : i, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (e = (a ? r(i, o, e) : r(e)) || e);
  return a && e && v(i, o, e), e;
};
let t = class extends m(l) {
  ...
  render() {
    return u`
      <h1>Live Video</h1>
      <p class="description">Live video streaming management. Configure streams, embed codes, and broadcast settings.</p>
      <div class="status-card">
        <div class="status-icon">⚙️</div>
        <div class="status-text">
          <h2>Live Video <span class="badge">Active</span></h2>
      ...
      <div class="config-section">
        ...
        <div class="form-field">
          <label>Status</label>
          <uui-toggle label="Enable Live Video" checked></uui-toggle>
        </div>
        <div class="actions">
          <uui-button
            look="primary"
...
t = d([
  f("splatdev-live-video-dashboard")
], t);
const h = t;
export {
  t as SplatdevLiveVideoDashboardElement,
  h as default
};
