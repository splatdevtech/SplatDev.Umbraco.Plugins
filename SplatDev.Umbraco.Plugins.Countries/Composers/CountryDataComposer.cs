...
using SplatDev.Umbraco.Plugins.Countries.Migrations;

namespace SplatDev.Umbraco.Plugins.Countries.Composers
{
    public class CountrySchemaMigrationComposer : ComponentComposer<CountrySchemaComponent>
    {
    }

    public class CountrySchemaComponent(
        ...
        IRuntimeState runtimeState) : IComponent
    {
        ...
        public void Initialize()
        {
            ...
            var migrationPlan = new MigrationPlan("CountrySchema");

            // This is the steps we need to take
            // Each step in the migration adds a unique value
            migrationPlan.From(string.Empty)
                .To<CountryMigration>("countries-db");
