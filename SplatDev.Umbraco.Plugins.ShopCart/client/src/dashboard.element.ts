...
@customElement("splatdev-shopcart-dashboard")
export class SplatdevShopCartDashboardElement extends UmbElementMixin(LitElement) {
  ...
  override render() {
    return html`
      <h1>Shop Cart</h1>
      <p class="description">E-commerce shopping cart configuration. Manage products, pricing, and checkout settings.</p>
      <div class="status-card">
        <div class="status-icon">⚙️</div>
        <div class="status-text">
          <h2>Shop Cart <span class="badge">Active</span></h2>
      ...
      <div class="config-section">
        ...
        <div class="form-field">
          <label>Status</label>
          <uui-toggle label="Enable Shop Cart" checked></uui-toggle>
        </div>
        <div class="actions">
          <uui-button
            look="primary"
...
export default SplatdevShopCartDashboardElement;
