import { LitElement as d, html as u, css as c, state as p, customElement as f } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as g } from "@umbraco-cms/backoffice/element-api";
var m = Object.defineProperty, b = Object.getOwnPropertyDescriptor, l = (n, a, o, i) => {
  for (var e = i > 1 ? void 0 : i ? b(a, o) : a, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (e = (i ? s(a, o, e) : s(e)) || e);
  return i && e && m(a, o, e), e;
};
let t = class extends g(d) {
  ...
  render() {
    return u`
      <h1>RDP Manager</h1>
      <p class="description">Remote Desktop Protocol session manager. Configure and launch secure RDP connections.</p>
      <div class="status-card">
        <div class="status-icon">⚙️</div>
        <div class="status-text">
          <h2>RDP Manager <span class="badge">Active</span></h2>
      ...
      <div class="config-section">
        ...
        <div class="form-field">
          <label>Status</label>
          <uui-toggle label="Enable RDP Manager" checked></uui-toggle>
        </div>
        <div class="actions">
          <uui-button
            look="primary"
...
t = l([
  f("splatdev-rdp-dashboard")
], t);
const h = t;
export {
  t as SplatdevRDPManagerDashboardElement,
  h as default
};
