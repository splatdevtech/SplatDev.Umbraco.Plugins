...
@customElement("splatdev-rdp-dashboard")
export class SplatdevRDPManagerDashboardElement extends UmbElementMixin(LitElement) {
...
export default SplatdevRDPManagerDashboardElement;
